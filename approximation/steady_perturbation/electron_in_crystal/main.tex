    ...
    \begin{enumerate}
      \item バンドギャップの成り立ち \par
        ...
        \begin{align}
          ...
          \end{dcases}
        \end{align}
        である．なお，$q_+ = q_- = 0$となるのは$g = 0$であるが，$g$の定義である\refe{wave-number-g-def}よりありえない．エネルギーは，
        \begin{align}
        ...
        \end{align}
        となる．\refe{2nd-order-perturbation-eigenvalue-in-electron}の振る舞いを第1 Brillouinゾーンの内側と外側で確認する．
