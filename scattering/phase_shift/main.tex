...
\begin{document}
  ...
  \refe{1Dscattering}の第1式において，第1項は入射波を，第2項は反射波を表している．
  ...
  位相シフトの現象を3次元に拡張する．
  今回は全反射が起こるとする．
  \refe{PartialWave}において$r\to\infty$とすると，
  \begin{align}
  ...
  \begin{myex}{半径$a$の剛体球による散乱(再考)}{}
    ...
    \refe{SCPartialWave}において$l = 0$とすることで，
    \begin{align}
  ...
  \begin{myex}{位相シフトの問題}{}
    ...
    \begin{enumerate}
      \item 波動関数は剛体球の中に侵入できないため$r=a$で$\psi=0$である．よって，
        ...
        \end{align}
        が得られる．
      \item \refe{LimitOfBessel}を\refe{phaseshift}に代入すると，
        \begin{align}
