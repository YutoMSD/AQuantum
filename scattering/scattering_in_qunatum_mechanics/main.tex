...
\begin{document}
  ...
  \subsection{散乱振幅と微分断面積の関係}
    ...
    \end{align}
    と書けるのであった．
    入射波は$z$軸方向にのみ進行するので，その確率流密度の$z$成分$j_z$は\refe{psi-in-grad}より，
    \begin{align}
  ...
  \subsection{散乱振幅の表式}
    ...
    \begin{align}
      ...
      &= \e^{\i\kappa z} - \frac{1}{4\pi} \int \frac{\e^{\i \kappa \abs{\bm{r} - \bm{r'}}}}{\abs{\bm{r} - \bm{r'}}} \frac{2m}{\hbar^2}V(r')\psi(\bm{r'}) \dd{\bm{r'}}\label{formal-soultion}
    \end{align}
    である．
    \begin{figure}[H]
      \centering
    ...
    \begin{align}
      \psi(\bm{r}) = \e^{\i\kappa z} - \qty(\frac{1}{4\pi} \int \e^{-\i\bm{\kappa'}\cdot \bm{r'}} \frac{2m}{\hbar^2}V(r')\psi(\bm{r'})\dd{\bm{r'}})\frac{\e^{\i\kappa r}}{r}\label{psi-r-in-sc-kappa}
    \end{align}
    を得る．
    \par
    ...
    \begin{align}
      \psi(\bm{r}) = \e^{\i kz} - \qty(\frac{1}{4\pi} \int \e^{-\i\bm{k'}\cdot \bm{r'}} \frac{2m}{\hbar^2}V(r')\psi(\bm{r'})\dd{\bm{r'}})\frac{\e^{\i kr}}{r}
    \end{align}
    となる．
    したがって散乱振幅は，
    \begin{align}
    ...
    \begin{itembox}[l]{一般のポテンシャルでの散乱振幅}
      \begin{align}
        f(\theta) = -\frac{1}{4\pi} \int \e^{- \i \bm{k'} \cdot \bm{r'}} \frac{2m}{\hbar^2}V(r')\psi(\bm{r'})\dd{\bm{r'}}\label{scattering-amp-general}
      \end{align}
    \end{itembox}
\end{document}
