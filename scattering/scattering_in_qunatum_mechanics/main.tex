...
\begin{document}
  ...
  \subsection{散乱振幅の表式}
    ...
    \end{figure}
    以上の計算からSchrödinger方程式\refe{se-scattering}の形式解は
    \begin{align}
      \psi(\bm{r}) = \e^{\i kz} - \frac{1}{4\pi} \int \frac{\e^{\i k \abs{\bm{r} - \bm{r'}}}}{\abs{\bm{r} - \bm{r'}}} \frac{2m}{\hbar^2}V(r')\psi(\bm{r'}) \dd{r'}\label{formal-soultion}
    \end{align}
